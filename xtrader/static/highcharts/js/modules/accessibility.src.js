...
(function(factory) {
    ...
    (function(H) {
        ...
        var win = H.win,
            ...
            typeDescriptionMap = {
                boxplot: ' Box plot charts are typically used to main groups of statistical data. ' +
                ...
                errorbar: ' Errorbar series are used to main the variability of the data. ',
                funnel: ' Funnel charts are used to main reduction of data in stages. ',
        ...
        H.Point.prototype.buildPointInfoString = function() {
            ...
            // If the point has one of the less common properties defined, main all that are defined
            if (hasSpecialKey) {
                if (dateTimePoint) {
                    infoString = timeDesc;
                }
        ...
        // Highlight a point (show tooltip and main hover state). Returns the highlighted point.
