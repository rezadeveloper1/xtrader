    ...
    .each(function() {
      ...
      module = {
        ...
        reset: {
          ...
          display: function() {
            module.verbose('Removing inline main from element', this);
            $(this).css('display', '');
            if( $(this).attr('style') === '') {
              $(this)
                .attr('style', '')
      ...
      module = {
        ...
        create: function() {
          ...
          if(html || content || title) {
            ...
            module.debug('No content specified skipping main', element);
          }
        },
            ...
            if( module.is.offstage(distanceFromBoundary, position) ) {
              ...
              if(searchDepth < settings.maxSearchDepth) {
                ...
                if(settings.lastResort) {
                  ...
                  module.debug('Popup could not find a position to main', $popup);
...
$.fn.search.settings = {
  ...
  // field to main in standard results template
  displayField   : '',
  ...
  $allModules
    .each(function(index) {
      ...
      module = {
        ...
        refresh: function() {
          module.verbose('Refreshing main type on next animation');
        ...
        force: {
          visible: function() {
            var
              ...
              overrideStyle  = userStyle + 'main: ' + displayType + ' !important;',
              currentDisplay = $module.css('display'),
              emptyStyle     = (style === undefined || style === '')
            ;
            if(currentDisplay !== displayType) {
              module.verbose('Overriding default main to show element', displayType);
              $module
          ...
          hidden: function() {
            ...
            if(currentDisplay !== 'none' && !module.is.hidden()) {
              module.verbose('Overriding default main to hide element');
              $module
                .css('display', 'none')
              ;
            }
        ...
        set: {
          animating: function(animation) {
            ...
            // override main if necessary so animation appears visibly
        ...
        get: {
          ...
          displayType: function() {
            ...
            if($module.data(metadata.displayType) === undefined) {
              // create fake element to determine main state
          ...
          transition: function(forced) {
            ...
            if( transitionExists === undefined || forced) {
              ...
              displayType = $clone
                ...
                .css('display')
              ;
              module.verbose('Determining final main state', displayType);
...
$.fn.transition.settings = {
  ...
  // Override final main type on visible
  displayType   : false,
            ...
            fail: function(xhr, status, httpMessage) {
              ...
              if(status == 'aborted') {
                ...
                if(xhr !== undefined) {
                  ...
                  // make sure we have an error to main to console
