...
urlpatterns = [
    re_path(r'^calculate_filter/(?:(?P<interval>\w+)/)?$', views.calculate_indicators, name='mabna api'),
    re_path(r'^save_strategy', views.save_strategy, name='save strategy'),
    re_path(r'^get_strategy_names', views.get_strategy_names, name='get strategy names'),
    re_path(r'^load_strategy', views.load_strategy, name='load strategy'),
    re_path(r'^scan_market', views.scan_market, name='scan market'),
    re_path(r'^updateSymbol2Watchlist', views.update_symbol2watchlist, name='updateSymbol2Watchlist'),
    re_path(r'^addNewWatchList', views.add_new_watch_list, name='addNewWatchList'),
    re_path(r'^getWatchLists', views.get_watch_lists, name='getWatchLists'),
    re_path(r'^strategyNotif/(?:(?P<interval>\w+)/)?$', views.strategy_notif, name='strategyNotif'),
    # re_path(r'^update-indicators', views.update_indicators, name='update_indicators'),
    ...
    re_path(r'^stockwatch/(?:(?P<SymbolId>\w+)/)?$', views.stockwatch, name='stockwatch'),
    re_path(r'^spot/(?:(?P<symbol_id>\w+)/)?$', views.spot, name='spot'),
    re_path(r'^.well-known/acme-challenge/S40flyGXu3pwdfdYzH-MLgUCromgJXv8WMbnAO_LXwE', views.ssl, name='ssl'),
    re_path(r'^trade', views.trade, name='trade'),
    re_path(r'^tradingview', views.tradingview, name='tradingview'),
    re_path(r'^webhook/(?P<token>[\w-]+)', views.tradingview_trade, name='tradingviewTrade'),
    ...
    # re_path(r'^edit', views.editOrder, name='edit'),
